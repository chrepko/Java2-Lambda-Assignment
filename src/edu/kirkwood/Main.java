...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Predicate<Widget> zeroOrGreater = (Widget widget) -> widget.getValue() >= 0;
        ...
        UnaryOperator<Widget> nameToLower = (Widget widget) -> { widget.setName(widget.getName().toLowerCase()); return widget; };

        // STEP 8: Create a Consumer called "print" to print each Widget as a string on a new line using the .toString() method.
        // This code should be written on a single line.
        Consumer<Widget> print = (Widget widget) -> System.out.println(widget.toString());
